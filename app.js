...
function showPosition(position) {
    ...
    var markers = new google.maps.Marker({ position: lattlong, map: maps, title: "found it!" });
}
...
async function APICall() {
    ...
    let response = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&&appid=06d942f98e3257a76183cc5e6ddea94f`);
